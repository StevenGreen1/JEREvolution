...
#=================================================
rm -f $workDir/5x5_50x50_$2_$3_SiW.steer
cat > $workDir/5x5_50x50_$2_$3_SiW.steer << EOF
...
/Mokka/init/MokkaGearFileName /usera/sg568/ilcsoft_v01_17_07/JEREvolution/Stage2/MokkaSteering/MokkaGearFiles/ILD_o1_v06_5x5_50x50.gear
...
/Mokka/init/globalModelParameter Hcal_cells_size 50
/Mokka/init/globalModelParameter Hcal_digitization_tile_size 50

/Mokka/init/lcioDetailedShowerMode true

/Mokka/init/BatchMode true
/Mokka/init/lcioFilename /r06/lc/sg568/ReviewJER/Slcio/Stage2/5x5_50x50/ILD_o1_v06_$2_$3.slcio
/Mokka/init/initialMacroFile $workDir/5x5_50x50_$2_$3_SiW.g4macro

EOF
#=================================================

rm -rf $workDir/5x5_50x50_$2_$3_SiW.g4macro
cat >  $workDir/5x5_50x50_$2_$3_SiW.g4macro << EOF
...
Mokka -U $workDir/5x5_50x50_$2_$3_SiW.steer

exit

rm -rf $workDir/5x5_50x50_$2_$3_SiW.steer
rm -rf $workDir/5x5_50x50_$2_$3_SiW.g4macro
