...
#=================================================
rm -f $workDir/20x20_30x30_$2_$3_SiW.steer
cat > $workDir/20x20_30x30_$2_$3_SiW.steer << EOF
...
/Mokka/init/MokkaGearFileName /usera/sg568/ilcsoft_v01_17_07/JEREvolution/Stage2/MokkaSteering/MokkaGearFiles/ILD_o1_v06_20x20_30x30.gear
...
/Mokka/init/globalModelParameter Ecal_cells_size 20.0
/Mokka/init/globalModelParameter Ecal_Sc_N_strips_across_module 9
...
/Mokka/init/lcioFilename /r06/lc/sg568/ReviewJER/Slcio/Stage2/20x20_30x30/ILD_o1_v06_$2_$3.slcio
/Mokka/init/initialMacroFile $workDir/20x20_30x30_$2_$3_SiW.g4macro

EOF
#=================================================

rm -rf $workDir/20x20_30x30_$2_$3_SiW.g4macro
cat >  $workDir/20x20_30x30_$2_$3_SiW.g4macro << EOF
...
Mokka -U $workDir/20x20_30x30_$2_$3_SiW.steer

exit

rm -rf $workDir/20x20_30x30_$2_$3_SiW.steer
rm -rf $workDir/20x20_30x30_$2_$3_SiW.g4macro
