...
#=================================================
rm -f $workDir/15x15_30x30_$2_$3_SiW.steer
cat > $workDir/15x15_30x30_$2_$3_SiW.steer << EOF
...
/Mokka/init/MokkaGearFileName /usera/sg568/ilcsoft_v01_17_07/JEREvolution/Stage2/MokkaSteering/MokkaGearFiles/ILD_o1_v06_15x15_30x30.gear
...
/Mokka/init/globalModelParameter Ecal_cells_size 15.0
/Mokka/init/globalModelParameter Ecal_Sc_N_strips_across_module 12
...
/Mokka/init/lcioFilename /r06/lc/sg568/ReviewJER/Slcio/Stage2/15x15_30x30/ILD_o1_v06_$2_$3.slcio
/Mokka/init/initialMacroFile $workDir/15x15_30x30_$2_$3_SiW.g4macro

EOF
#=================================================

rm -rf $workDir/15x15_30x30_$2_$3_SiW.g4macro
cat >  $workDir/15x15_30x30_$2_$3_SiW.g4macro << EOF
...
Mokka -U $workDir/15x15_30x30_$2_$3_SiW.steer

exit

rm -rf $workDir/15x15_30x30_$2_$3_SiW.steer
rm -rf $workDir/15x15_30x30_$2_$3_SiW.g4macro
